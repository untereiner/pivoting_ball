...
void PivotingBall2::GetCircumscribedCircle(Vec3 p0, Vec3 p1, Vec3 p2, Vec3& center, double& radius)
{
	Vec3 d10 = p1 - p0;
	Vec3 d20 = p2 - p0;
	Vec3 d01 = p0 - p1;
...
bool PivotingBall2::IsOriented(Vec3 normal, Vec3 normal0, Vec3 normal1, Vec3 normal2)
{
	int count = 0;
...
bool PivotingBall2::GetBallCenter(Vertex index0, Vertex index1, Vertex index2, Vec3& center, Vertex* order)
{
	bool status = false;
...
void PivotingBall2::AddFrontEdge(CMap2::Edge edge)
{
...
void PivotingBall2::RemoveFrontEdge(std::list<CMap2::Edge>::iterator edge)
{
	CMap2::Vertex startVertex2 = CMap2::Vertex(edge->dart);
	Vertex startVertex0 = surfaceVertexes[startVertex2];
...
std::list<CMap2::Edge>::iterator PivotingBall2::FindFrontEdge(CMap2::Edge edge)
{
...
std::vector<PivotingBall2::Vertex> PivotingBall2::GetNeighbors(Vec3 position, float radius)
{
...
bool PivotingBall2::FrontIsEmpty()
{
	return front.empty(); 
}
